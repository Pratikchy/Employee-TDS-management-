...
npm install
Set up environment variables: Create a .env file in the tds-backend/ directory:
...
👥 User Roles
Admin: System administration, user management, approval authority
HR: Employee record management, TDS approval, payroll processing
Employee: View personal TDS details and Form 16
🔧 Available Scripts
# Start the development server
npm start
...
Login: Use credentials to log in
Navigate: Access appropriate dashboard based on role
